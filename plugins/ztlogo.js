...
const lol = "```TYPE SOME WORD AFTER COMMAND!``` \n\n 💕 *Kyouko* 💕"
    

    if (Config.WORKTYPE == 'private') {

    Asena.addCommand({ pattern: 'ztlogo ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'ztlogo ?(.*)', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
