    ...
    Asena.addCommand({pattern: 'menu ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
        ...
        if (match[1] === '') {
            ...
            await message.client.sendMessage(
                message.jid,'●' + Config.MENUTEXT + '●' + ll + CMD_HELP + ss, MessageType.text,{quoted: message.data}
            );
        }
    }));
}
