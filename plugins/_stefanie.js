...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: `${Config.PANEL_COMMAND} ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'kaweesha ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
...
async function checkImAdmin(message, user = message.client.user.jid) {
    ...
    return sonuc.includes(true);
     ...
     Asena.addCommand({pattern: `${Config.PANEL_COMMAND} ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'kaweesha ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
