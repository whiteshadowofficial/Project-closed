...
if (Config.WORKTYPE == 'private') {
    ...
    Amdi.applyCMD({pattern: 'asena ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Amdi.applyCMD({pattern: 'asena ?(.*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
