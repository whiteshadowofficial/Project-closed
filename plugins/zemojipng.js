...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({pattern: 'zemoj ?(.*)', fromMe: true, desc: des}, (async (message, match) => {
        ...
        await message.sendMessage(Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.png, caption: 'ᑕᖇEᗩTEᗪ ᗷY 💕 *Kyouko* 💕'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Asena.addCommand({pattern: 'zemoj ?(.*)', fromMe: false, desc: des}, (async (message, match) => {
