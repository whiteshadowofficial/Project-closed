...
const NEED_WORDC = "must inter github user name"
const USAGE = "..."
...
tenu.addCommand({ pattern: 'github ?(.*)', fromMe: true, desc: Glang.GITHUB_DESC}, async (message, match) => {
...
tenu.addCommand({ pattern: 'github ?(.*)', fromMe: false, desc: Glang.GITHUB_DESC}, async (message, match) => {
